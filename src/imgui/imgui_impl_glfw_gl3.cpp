...
// (GLFW is a cross-platform general purpose library for handling windows, inputs, OpenGL/Vulkan renderer context creation, etc.)
...
{
    // Avoid renderer when minimized, scale coordinates for retina displays (screen coordinates != framebuffer coordinates)
...
bool ImGui_ImplGlfwGL3_CreateFontsTexture()
{
    ...
    // Upload texture to renderer system
    GLint last_texture;
